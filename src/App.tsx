...
function App() {
  ...
  return (
    <div className="min-h-screen bg-blue-50 relative">
      <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-blue-200 to-transparent pointer-events-none"></div>
      <div className="max-w-3xl mx-auto px-6 py-12 relative">
        <header className="mb-8">
          <h1 className="text-4xl font-extrabold text-blue-950 tracking-tight">
            Calm HN
          </h1>
          <p className="text-blue-400 text-[10px] mt-2 uppercase tracking-wider">
        ...
        <div className="space-y-6">
          {stories.map((story, index) => (
            <article key={story.id} className="group -mx-3 px-3 py-3 rounded-lg hover:bg-blue-100 transition-colors duration-300 relative">
              <a
              ...
              <div className="grid grid-cols-[auto_1fr] gap-x-3 gap-y-1 relative z-10 pointer-events-none">
                <span className="bg-blue-100 text-blue-400 text-[10px] leading-none font-medium px-2 py-0.5 rounded-full flex-shrink-0 self-center mt-px group-hover:bg-blue-300 group-hover:text-blue-700 transition-colors group-hover:duration-[750ms] duration-300">
                  {index + 1}
                </span>
                <h2 className="text-blue-950 text-lg leading-relaxed">
                ...
                <div></div>
                <div className="flex items-center gap-3 text-xs text-blue-400 group-hover:text-blue-500 transition-colors duration-300">
